/**
 * Kafka Consumer Utility for Payment Service
 * 
 * This file provides Kafka consumer functionality for consuming events.
 */
...
const kafkaConfig: KafkaConfig = {
  clientId: process.env.KAFKA_CLIENT_ID || 'payment-service-client',
